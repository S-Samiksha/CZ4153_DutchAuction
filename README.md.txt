...
# Things to do:
   ...
   3. what are we sending to the "winners" --> ERC20 tokens 
   4. Ending auction function (relate to point 3)
   5. Do the testing
   6. Do the front end
   7. re entry attack PoC
   8. ERC20 integration --> Implemented 
   9. can the owner of the contract take part in the auction? --> no --> Implemented
   10. only owner can end auction and burn the tokens or timer can end auction
   11. Tests to be dynamic with the constructor functions --> Implemented 
